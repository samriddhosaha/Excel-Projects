...
In this project I set out to understand what skills top employers request and how to land more pay.

### Questions to Analyze

To understand particularly the data science job market, I asked the following:
...
- 🧮 Then I added new measure to calculate the median salary of jobs country wise.
    ```
    =CALCULATE(
        MEDIAN(data_jobs_all[salary_year_avg]),
        data_jobs_all[job_country] = "<Country Name>")
    ```
